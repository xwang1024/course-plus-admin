...
module.exports = exports = function () {
  ...
  // restful接口
  let modelList = ['admin', 'asset', 'attachment', 'author', 'comment', 'course', 'school',
                   'speciality', 'topic', 'topicBody', 'user', 'feedback', 'question', 'trade']
  ...
  router.get(`/question/reply/:id`, require(`../controllers/question/view`).reply);
  router.get(`/feedback`  , require(`../controllers/feedback/view`).index);
  router.get(`/trade`     , require(`../controllers/trade/view`).index);
