...
module.exports = exports = function () {
  ...
  router.get(`/topic/detail`  , require(`../controllers/topic/view`).detail);
  router.get(`/topic/create`  , require(`../controllers/topic/view`).create);
  router.get(`/topic/modify`  , require(`../controllers/topic/view`).modify);
  router.get(`/attachment`, require(`../controllers/attachment/view`).index);
  router.get(`/author`    , require(`../controllers/author/view`).index);
  router.get(`/author/detail` , require(`../controllers/author/view`).detail);
  router.get(`/author/create` , require(`../controllers/author/view`).create);
  router.get(`/author/modify` , require(`../controllers/author/view`).modify);
