...
module.exports = function (app, sequelize) {
  ...
  Attachment.hasOne(Author);
  Author.belongsTo(Attachment);
  ...
  User.belongsToMany(Attachment, {
    through: {
      model: Trade
    },
    foreignKey: 'userId'
  });
  Attachment.belongsToMany(User, {
    through: {
      model: Trade
    },
  ...
  var createOrder = ['School', 'Speciality', 'Course', 'Attachment', 'Author', 'Topic', 'TopicBody', 'Asset', 'AssetTopicBody', 'User', 'Trade' ,'Comment', 'Admin'];
